...
const perguntas = [
  ...
  },
  {
    ...
    resposta: (
      <span>Não, este não é um site oficial da UFBA e não possui nenhum apoio institucional. Trata-se de um projeto do Laboratório de Ideias do Instituto de Computação, uma iniciativa de uma aluna do IC.</span>
    ),
  },
  {
    pergunta: "O site está com problema",
    resposta: (
      <span>Isso pode acontecer! Por ser uma iniciativa individual e estar no início, o sistema está sujeito a erros e evoluções. Por favor, relate o problema pelo formulário de contato para que seja possível trabalhar na solução.<br />
  ...
  },
  {
    ...
    resposta: (
      <span>Seja bem-vindo(a) para participar! Você pode contribuir com ideias, sugestões ou código. Use o formulário de contato para comunicar ou acesse o projeto no GitHub.<br />
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto">
            Encontre respostas para as dúvidas mais comuns sobre o sistema de conversão de horários.
          </p>
        </div>
